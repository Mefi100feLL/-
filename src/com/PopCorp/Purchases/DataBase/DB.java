...
public class DB {
	...
	public static final String[] COLUMNS_ALL_ITEMS = new String[] {KEY_ALL_ITEMS_NAME, KEY_ALL_ITEMS_COUNT, KEY_ALL_ITEMS_EDIZM,
		KEY_ALL_ITEMS_COAST, KEY_ALL_ITEMS_CATEGORY, KEY_ALL_ITEMS_SHOP, KEY_ALL_ITEMS_COMMENT};
	...
	public static final String CREATE_TABLE_ALL_ITEMS = "CREATE TABLE IF NOT EXISTS " + TABLE_ALL_ITEMS + 
			...
			KEY_ALL_ITEMS_CATEGORY + " text, " + KEY_ALL_ITEMS_SHOP + " text, " + KEY_ALL_ITEMS_COMMENT + " text);";
	...
	public static final String KEY_SALES_CATEGORY = "category";
	...
	public static final String[] COLUMNS_SALES = new String[] {KEY_SALES_ID_SALE, KEY_SALES_TITLE, KEY_SALES_SUBTITLE, KEY_SALES_COAST,
		KEY_SALES_COUNT, KEY_SALES_COAST_FOR, KEY_SALES_IMAGE_URL, KEY_SALES_ID_IMAGE, KEY_SALES_SHOP, KEY_SALES_CATEGORY, KEY_SALES_PERIOD_BEGIN, KEY_SALES_PERIOD_FINISH};
	...
	public static final String CREATE_TABLE_SALES = "CREATE TABLE IF NOT EXISTS " + TABLE_SALES + 
			...
			KEY_SALES_SHOP + " text, " + KEY_SALES_CATEGORY + " text, " + KEY_SALES_PERIOD_BEGIN + " text, " + KEY_SALES_PERIOD_FINISH + " text);";
	...
	public void close() {//закрываем соединение
		if (DBHelper!=null){
			DBHelper.close();
		}
		closed=true;
	...
	public Cursor getAllData(String table) {//получить все записи из таблицы
		try{
	...
	public void changeRec(String table, String column,int id, String txt) {//изменить запись
	...
	public long addRec(String table, String[] columns, String[] values) {//добавить запись
		ContentValues cv = new ContentValues();
	...
	public void createtable(String table, String[] name, String[] type){//создаем таблицу, если еЄ нет
	...
	//получить данные из столбца по условию
