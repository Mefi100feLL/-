...
public class DBHelper extends SQLiteOpenHelper {
	...
	//изменяем таблицу со всеми товарами в зависимости от версии
	...
	//изменяем таблицы с товарами, переносим записи в одну таблицу и удаляем их
	...
	//изменяем таблицы с товарами для версии 1 и 2
	...
	//изменяем таблицы с товарами для версии 1 и 2 (действия в цикле)
	...
	//переносим товары из старых таблиц в одну новую
	...
	//переносим товары из старой таблицы в одну новую
	...
	//кладем записи из курсора в таблицу с вычетом поля _id и прибавлением поля datelist
	...
	//изменяем таблицу Favorites или создаем в зависимости от версии
	...
	//если старая версия < 4, то переименовываем таблицу со списками и добавляем поле синхронизации
