...
public class ListWriter
{
	...
	{
		Collections.sort(array, new SortOnlyCategories(context));
		...
		for (ListItem item : array){
			...
			if (!item.getComment().equals("")){
				resultString += "_" + item.getComment().replace("_", " ") + "_";
			}
	...
	public void read(DB db, Context context, String dataFromClip, List list, boolean changeList){
